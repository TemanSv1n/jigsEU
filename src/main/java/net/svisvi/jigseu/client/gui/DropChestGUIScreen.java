...
public class DropChestGUIScreen extends AbstractContainerScreen<DropChestGUIMenu> {
	...
	protected void renderBg(PoseStack ms, float partialTicks, int gx, int gy) {
		...
		RenderSystem.setShaderTexture(0, new ResourceLocation("jigseu:textures/screens/pack.png"));
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, new TranslatableComponent("gui.jigseu.drop_chest_gui.label_only_showing_break_block_for_i"), 3, 56, -15263977);
	}
