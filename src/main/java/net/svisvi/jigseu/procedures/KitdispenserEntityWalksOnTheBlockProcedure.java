	...
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if ((world.getBlockState(new BlockPos(x, y - 3, z))).getBlock() == Blocks.CHEST) {
			if (entity instanceof LivingEntity _entity) {
				...
				}.getItemStack(world, new BlockPos(x, y - 3, z), 22));
				...
				}.getAmount(world, new BlockPos(x, y - 3, z), 22));
			...
			}
			{
				...
				if (_entity instanceof Player _player) {
					...
					}.getItemStack(world, new BlockPos(x, y - 3, z), 23)));
					_player.getInventory().setChanged();
			...
			}
			{
				...
				if (_entity instanceof Player _player) {
					...
					}.getItemStack(world, new BlockPos(x, y - 3, z), 24)));
					_player.getInventory().setChanged();
				} else if (_entity instanceof LivingEntity _living) {
			...
			}
			{
				...
				if (_entity instanceof Player _player) {
					...
					}.getItemStack(world, new BlockPos(x, y - 3, z), 25)));
					_player.getInventory().setChanged();
				} else if (_entity instanceof LivingEntity _living) {
			...
			}
			{
				...
				if (_entity instanceof Player _player) {
					...
					}.getItemStack(world, new BlockPos(x, y - 3, z), 26)));
					_player.getInventory().setChanged();
				} else if (_entity instanceof LivingEntity _living) {
			...
			while (slot < 22) {
				{
					...
					}.getItemStack(world, new BlockPos(x, y - 3, z), (int) slot));
					_setstack.setCount(new Object() {
						public int getAmount(LevelAccessor world, BlockPos pos, int slotid) {
							AtomicInteger _retval = new AtomicInteger(0);
							BlockEntity _ent = world.getBlockEntity(pos);
					...
					}.getAmount(world, new BlockPos(x, y - 3, z), (int) slot));
			...
			}
			{
				...
				}.getValue(world, new BlockPos(x, y, z), "x")), (new Object() {
					public double getValue(LevelAccessor world, BlockPos pos, String tag) {
						BlockEntity blockEntity = world.getBlockEntity(pos);
						if (blockEntity != null)
							return blockEntity.getTileData().getDouble(tag);
				...
				}.getValue(world, new BlockPos(x, y, z), "y")), (new Object() {
					public double getValue(LevelAccessor world, BlockPos pos, String tag) {
						BlockEntity blockEntity = world.getBlockEntity(pos);
						if (blockEntity != null)
							return blockEntity.getTileData().getDouble(tag);
				...
				}.getValue(world, new BlockPos(x, y, z), "z")));
				if (_ent instanceof ServerPlayer _serverPlayer)
					...
					}.getValue(world, new BlockPos(x, y, z), "z")), _ent.getYRot(), _ent.getXRot());
			}
		}
	}
}
